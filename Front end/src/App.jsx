...
function App() {
  ...
  useEffect(() => {
    fetch(" https://finance-trackerdeploy-qw97.onrender.comtransactions")
      .then((res) => res.json())
      .then((data) => {
  ...
  const addTransaction = async (tx) => {
    try {
      const res = await fetch(" https://finance-trackerdeploy-qw97.onrender.comtransactions", {
        method: "POST",
  ...
  const deleteTransaction = async (_id) => {
    try {
      await fetch(` https://finance-trackerdeploy-qw97.onrender.comtransactions/${_id}`, {
        method: "DELETE",
      });
