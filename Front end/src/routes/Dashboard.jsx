      ...
      >
        ...
        <Card className="card4">
          ...
          <CardContent>
            ...
            <p  style={{color: "black"}} className="text-muted-foreground">
        ...
        <Card className="card7">
          ...
          >
            ...
            <PieChart className="sub-container-icon-medium" color="black" />
          </CardHeader>
          <CardContent>
            ...
            <p style={{color: "black"}} className="text-muted-foreground"> Highest spending Category</p>
          </CardContent>
        </Card>
      </div>
